            ...
            <div id="footer-content-container">
                <div id="footer-grid-content-container" class="logged">
                    <div id="contact-us-container">
                        ...
                        <p>Discord: <a href="https://discord.gg/pSTMacJZsK" target="_blank" rel=noreferrer style="margin-left: 1.8rem;">{$content.inviteLink}</a></p>
                    </div>
                </div>
                <button on:click={() => {location.href='#'}} id="footer-up" aria-label="go up">
                    <svg xmlns="http://www.w3.org/2000/svg" width="42.545" height="72.601" viewBox="0 0 42.545 72.601">
                        ...
                        <rect id="Rectangle_146" data-name="Rectangle 146" width="11" height="51" rx="5.5" transform="translate(22 24)" fill="#D87819"/>
                        <path id="Path_1145" data-name="Path 1145" d="M23.814,4.021a5,5,0,0,1,7.372,0l16.134,17.6c2.94,3.207,1.046,10.4-3.686,8.379S28.02,14.081,28.391,13.524,16.544,27.976,11.366,30,4.741,24.828,7.68,21.621Z" fill="#D87819"/>
                        </g>
                    </svg>                              
                </button>
...
footer {
    ...
    width: 100%;
    height: auto;
    background: #5e6551;/*var(--dark-green);*/
    border-top: #D87819 solid 0.5rem;
}
